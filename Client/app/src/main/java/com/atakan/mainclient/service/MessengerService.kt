...
class MessengerService : Service(){
    ...
    private fun sendMessageToServer(){
        ...
        val bundle = Bundle()
        val resource: ImageData = ImageData(image = viewModel.imageLive.value!!, action = viewModel.action)
